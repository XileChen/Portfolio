...
## Projects
### Project 1: [Early Detection Of Alzheimer’s Disease: From Logistic Regression To XGBoost]
#### Description
...
### Project 6: [Martian Robot Society]
#### Description

This project models a fictional Martian society where robots form hierarchical citizen structures. It involves advanced object-oriented design, including tree structures, voting mechanisms, and data aggregation. The project showcases the creation of interconnected systems for managing citizens, leaders, and societal behaviors. Built to explore Python’s capabilities in handling hierarchical data and complex relationships.
...
- **Concepts**:
  - Object-Oriented Programming (OOP)
  - Tree structures and hierarchy modeling
  - Algorithmic problem-solving
- **Tools**:
  - Unit testing with `unittest`
  - Modular design and abstraction

#### GitHub Repository [https://github.com/XileChen/Martian-Robot-Society
